...
@interface ScanConnectViewController ()<MinewModuleManagerDelegate,UITextFieldDelegate,CAAnimationDelegate>
...
@implementation ScanConnectViewController
{
...
//
- (void)connectSucessSkipToNextVC {
    ...
    ScanConnectViewController *connectVC = [scanStory instantiateViewControllerWithIdentifier:storyboardName];
